...
const LINE_PLACEHOLDERS = [
  ...
  "その上でこれまでの経験や強みを共に確認し、〇〇と捉えている前提を言語化し、自己理解を促す",
  "〇〇を共に確認し課題を整理する。（整理し仕事理解を促す。）",
  "実際の〇〇（仕事理解）と、〇〇と捉えている前提（自己理解）を、照らし合わせて（すり合わせて）、適合性の（妥当性の）再検討を促す。比較検討を促す／",
  "Ａ案と、Ｂ案を比較し、重視する価値観／条件／判断軸の明確化を促す。",
